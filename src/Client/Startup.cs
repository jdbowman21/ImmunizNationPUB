...
namespace ImmunizNation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
            {
                ...
                options.UseSqlServer(connectionString,
                    sqlServerOptionsAction: sqlOptions =>
                    {
                        ...
                        sqlOptions.EnableRetryOnFailure(maxRetryCount: Configuration.GetValue<int>("MigrationMaxRetryCount"), maxRetryDelay: TimeSpan.FromSeconds(30), errorNumbersToAdd: null);
                    });
            });
            ...
            services.AddTransient<IKnowledgeTestService, KnowledgeTestService>()
                .AddTransient<IReflectiveQuestionsService, ReflectiveQuestionsService>()
                .AddTransient<IEvaluationSurveyService, EvaluationSurveyService>()
                ...
                .AddTransient<IEmailSender, MailKitEmailSender>()
